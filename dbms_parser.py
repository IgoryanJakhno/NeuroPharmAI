...
class DBMSParser:
    ...
    def format_for_llm(self, response: Dict[str, Any]) -> str:
        ...
        llm_prompt = (
            ...
            f"Постарайся сохранить информативность исходного ответа. Выдели самое важно, по необходимости группируй похожие события. На основе твоих знаний добавляй к части препаратов краткое описание.\n\n"
